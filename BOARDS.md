...
| --- | --- | --- | --- |
| **NEW-2** | **Note A — composition order.** Add site, roof, basement and electric sheets so the dealt set matches the approved sheet order. Also switch the scale ladder to try 3/16" first and never step up. | 2–4 h | The whole default-set feature reads as half-finished until this lands. |
